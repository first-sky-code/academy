                ...
                <div class="col-12 col-sm-8 col-md-6 col-lg-5 col-xl-4">
                    <div class="bg-light rounded p-4 p-sm-5 my-4 mx-3 shadow">
                        <div class="d-flex align-items-center justify-content-between mb-3">
                            <h3>Login dulu disini!</h3>
                        </div>
                        <form action="{{ route('user.login.submit') }}" method="POST">
                            @csrf
                            <div class="form-floating mb-3">
                                <input type="text" class="form-control @error('peserta_email') is-invalid @enderror"
                                    id="peserta_email" placeholder="email@email.com" name="peserta_email"
                                    value="{{ old('peserta_email') }}">
                                <label for="peserta_email">Email</label>
                            ...
                            <p class="text-center mb-0">Don't have an Account? <a
                                    href="{{ route('user.register') }}">Sign Up</a></p>
                        </form>
                    </div>
                </div>
            </div>
