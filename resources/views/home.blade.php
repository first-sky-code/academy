                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="hero-content-wrapper">
                            ...
                            <p class="mb-30 wow fadeInUp" data-wow-delay=".4s">Berminat? Segera registrasi dan ikuti
                                pelatihan kami!</p>
                            <a href="/auth-google-redirect" class="button button-lg radius-50 wow fadeInUp"
                                data-wow-delay=".6s">Registrasi Akun <i class="lni lni-chevron-right"></i> </a>
                        </div>
                    </div>
    ...
    <footer class="footer footer-style-4">
        <div class="container">
            <div class="copyright-wrapper wow fadeInUp" data-wow-delay=".2s">
                <p>Design and Developed by <a href="https://uideck.com" rel="nofollow" target="_blank">Firsky</a></p>
            </div>
        </div>
    </footer>
    <!-- ========================= footer style-4 end ========================= -->
